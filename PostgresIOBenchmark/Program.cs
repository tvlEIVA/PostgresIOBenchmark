...
var connString = "Host=db;Port=5432;Username=postgres;Password=postgres;Database=benchmarkdb"; // Postgres in
...
await PostgresSimpleInsertBenchmark.Run(
    connString,
    $"benchmark_simpleInsert_internalDatabase_{osVersion}.csv"
);
